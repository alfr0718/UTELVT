...
$this->title = 'Libros Más Solicitados: ' . ($mesSeleccionado ? $meses[$mesSeleccionado] : '') . ' - ' . ($anioSeleccionado ? $anioSeleccionado : '');
$this->params['breadcrumbs'][] = $this->title;

$secciones = \app\models\Seccion::find()
    ->where([])
    ->orderBy(['NombreSeccion' => SORT_ASC])
    ->all();
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Generador Estadístico Mes-Año</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <?= Html::dropDownList('mes', $mesSeleccionado, $meses,  ['class' => 'form-control']) ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <?= Html::button('<i class="fas fa-eraser"></i>', ['class' => 'btn btn-outline-secondary', 'onclick' => 'window.location.href = "' . Yii::$app->urlManager->createUrl(['estadistica/asignatura-libro']) . '"']) ?>
