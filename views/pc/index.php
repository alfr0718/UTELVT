                            ...
                            'buttons' => [
                                'PrestarEquipo' => function ($url, $model, $key) {
                                    ...
                                    return Html::button($icon, [
                                        ...
                                        'onclick' => 'showEquipoModal(' . $model->idpc . ', "' . Url::to(['/solicitud/solicitar-equipo']) . '")', // Llamar a la función JavaScript con el ID del modelo y la URL
                                    ]);
                                },
                            ],
...
<div class="modal fade" id="equipo-modal">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header bg-teal justify-content-center">
                <h4 class="modal-title">Solicitar Equipo &nbsp;&nbsp;<i class="fas fa-laptop fa-lg"></i></h4>
